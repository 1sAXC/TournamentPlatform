...
public interface IAdminUsersService
{
    ...
    Task<Result> BlockUserAsync(Guid userId, Guid currentAdminUserId, CancellationToken cancellationToken = default);
    Task<Result<AdminUserResponse>> UnblockUserAsync(Guid userId, CancellationToken cancellationToken = default);
