...
import type {
  ...
  MatchDetailsResponse, TournamentDetailsResponse, TournamentListItemResponse,
} from './types';
...
export const tournamentsApi = {
  ...
  getMatchDetails: (tournamentId: string, matchId: string) =>
    http.get<MatchDetailsResponse>(
