...
const errorCodeMap: Record<string, string> = {
  ...
  'Admin.LastAdminBlockNotAllowed': 'Нельзя заблокировать последнего активного администратора',
  'Admin.UserNotBlocked': 'Разблокировать можно только заблокированного пользователя',
